...
<pre>
container_pull(<a href="#container_pull.name">name</a>, <a href="#container_pull.image_name">image_name</a>, <a href="#container_pull.image_reference">image_reference</a>, <a href="#container_pull.image_tag">image_tag</a>, <a href="#container_pull.registry">registry</a>)
</pre>
...
<table class="params-table">
  ...
  <tbody>
    ...
    <tr id="container_pull.image_tag">
      ...
      <td>
        <p><code>String; Optional</code></p>
        <p>The tag of the image, only used for tagging not for pulling.</p>
      </td>
    </tr>
    <tr id="container_pull.registry">
      <td><code>registry</code></td>
      <td>
        <p><code>String; Required</code></p>
        <p>The url of the container registry.</p>
      </td>
    </tr>
  </tbody>
</table>
